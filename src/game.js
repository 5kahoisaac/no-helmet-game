...
class Maze {
    constructor() {
        this.grid = [];
        this.size = 31; // Odd size for proper maze generation
        this.cellSize = 19;
        this.start = { x: 1, y: 1 };
        this.helmetPosition = { x: 29, y: 29 }; // Fixed bottom right
